...
namespace rocketfellows\HUVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\HUVatNumberFormatValidatorsConfig\HUVatNumberFormatValidatorsConfig;

class HUVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = HUVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = HUVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::HU(), $config->getCountry());
    }
